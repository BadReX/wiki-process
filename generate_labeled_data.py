...
with open('/home/babdulla/DNN/wiki-data/wikidocs.IVs', mode="w") as ivFile:
    for words in doc_words:
        ivFile.write(' '.join(words) + '\n')

with open('/home/babdulla/DNN/wiki-data/wikidocs.OOVs', mode="w") as oovFile:
    for OOVs in doc_OOV_PNs:
        oovFile.write(' '.join(OOVs) + '\n')

with open('/home/babdulla/DNN/wiki-data/wikidocs.clusters', mode="w") as cFile:
